...
// Custom config for STM32F3, only crsf protocol, disable gps_rescue, only tramp vtx, no vtx table, no external osd, only NMEA gps, no sdcard, no osd profiles, no up link power for crsf
#ifdef F3_CUSTOM2
